...
namespace Gigamonkey::Boost {
    ...
    public:
        ...
        response operator()(
            ...
            std::cout << "Boost test : reading in test cases." << std::endl;
            ...
            std::cout << "Boost test 1: checking validity of output scripts." << std::endl;
            ...
            /*std::cout << "Boost test 4: proofs from inputs and outputs." << std::endl;
            ...
            std::cout << "Boost test 7: scripts" << std::endl;
