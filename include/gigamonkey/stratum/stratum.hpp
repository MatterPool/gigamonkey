...
namespace Gigamonkey {
    // See: https://github.com/MatterPool/Tech-Roadmap/wiki/POW-Boost-and-Stratum
    
    // See: https://github.com/MatterPool/Tech-Roadmap/wiki/Upgrading-BTC-Pool-to-Support-Boost#step-1-basic-types-and-functions
